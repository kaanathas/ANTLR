...
export default class ECMAScriptListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by ECMAScriptParser#NumberExpression.
	enterNumberExpression(ctx) {
	}

	// Exit a parse tree produced by ECMAScriptParser#NumberExpression.
